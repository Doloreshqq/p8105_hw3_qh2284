...
In 2002, `r states_2002` could be observed at 7 or more locations.

In 2010, `r states_2010` could be observed at 7 or more locations.
...
We could observe that there are about half of the male and female have the education level of more than high school. We could simply observe the distribution of education within the male and female.
...
ggplot(total_ac, aes(x = age, y = total, color = sex)) +
